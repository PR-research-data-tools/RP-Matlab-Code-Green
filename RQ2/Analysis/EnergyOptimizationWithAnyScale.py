...
if __name__ == "__main__":
    ...
    resource_folder = "./../resource/" #create a resource folder and clone the repositories (given in the  projects.csv) in a folder repos_projects_filtered_top100stars
    input_project_folder_path = "./../resource/sampling/repos_projects_filtered_top100stars/"
    input_csv_path = os.path.join("./../RQ1/Dataset", "entrypoints_no_crashes_only.csv")  # Path to the CSV file containing execution times
